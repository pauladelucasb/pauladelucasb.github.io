...
I'd love to hear from you! Please use the form below to send me a message.
  ...
  <form action="https://formsubmit.co/pd758@georgetown.edu" method="POST" style="max-width: 600px;">
    ...
    <div style="margin-bottom: 15px;">
      ...
      <input type="text" id="subject" name="subject" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;">
    </div>

    <div style="margin-bottom: 15px;">
      <label for="message"><strong>Message:</strong></label>
      <textarea id="message" name="message" rows="6" required style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;"></textarea>
    </div>
